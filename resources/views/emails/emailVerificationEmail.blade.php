                ...
                <table style="background: #fff; max-width:670px; margin:0 auto; padding: 20px; text-align: left;" width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="text-align: left; padding: 0; margin: 0;">
                            ...
                            <a style="text-decoration: underline; font-family: 'Poppins', sans-serif; font-size: 15px; line-height: 24px; color: #0A0A0A;" href="https://www.merchantbay.com/global/" target="_blank">https://www.merchantbay.com/global/</a>
                        </td>
                    </tr>
                    <tr>
                           ...
                           <ul style="margin: 0 0 0 30px; padding: 0;">
                               ...
                               <li style="margin: 0px 0px 30px 0px; padding: 0px;">
                                ...
                                <li style="margin: 0px 0px 30px 0px; padding: 0px;">
                                    ...
                                    <p style="margin: 0; padding: 0px; font-family: 'Poppins', sans-serif; font-size: 15px; line-height: 24px; color: #0A0A0A;">Our tech enabled fashion sourcing ecosystem has much more to offer. Learn more <a href="https://www.merchantbay.com/global/aboutus" style="color: #0000FF; text-decoration: underline; font-size: 15px;" target="_blank"> about us</a>... </p>
                                </li>
                           </ul>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center; padding: 30px; margin: 0;">
                            ...
                            <span style="text-align: center; display: block;  padding: 30px 0 40px; margin: 0; line-height: 45px;">
                                <a target="_blank" href="https://www.merchantbay.com/global/" style="background: #54A958; font-family: 'Poppins', sans-serif; font-size: 16px; line-height: 24px; border-radius: 8px; padding: 10px 20px; margin: 0; color: #fff; text-decoration: none;">Visit Merchant Bay</a>
                            </span>
                        </td>
                    </tr>
                </table>
                ...
                <table style="background: #fff; max-width: 670px; margin:0 auto; padding: 0;" width="100%"  border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="background: #eeeeee; text-align: center; padding: 20px 0; margin: 0;">
                            <h2 style="font-family: 'Poppins', sans-serif; font-size: 22px; line-height: 40px; margin: 0; padding: 0px; color: #0A0A0A;">Bring the sourcing in your pocket</h2>
