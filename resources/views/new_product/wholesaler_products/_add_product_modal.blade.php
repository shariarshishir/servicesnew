        ...
        <form method="POST" action="javascript:void(0);" enctype="multipart/form-data" id="seller_product_form">
            ...
            <div class="wholesaler_add_product_form">
                ...
                <div class="input-field">
                    <div class="row">
                        <div class="col s12 m3 l3">
                            <label for="product_type_mapping">Product type mapping <span class="text-danger">*</span></label>
                        </div>
                ...
                <div class="row input-field ">
                    ...
                    <div class="col s12 m9 l9">
                        ...
                        @else
                            <label class="radio_box">
                                <input class="with-gap" name="product_type" type="radio" value="4" checked="checked" />
                ...
                <div class="row input-field ">
                    ...
                    <div class="col s12 m9 l9">
                        <div class="radio-block">
                            ...
                            <label class="radio_box">
                                <input class="with-gap" name="gender" type="radio" value="unisex" />
                                <span>Unisex</span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="mb" >
                    <div class="col s12">
                        <div class="color-and-size-block">
                            <div class="no_more_tables">
                                <table class="mb-color-size-table-block add-color-sizes">
                                    <thead class="cf">
                                        <tr>
                                            <th>Color</th>
                                            <th>XXS</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td data-title="Color"><input type="text"  class="form-control" name="mb_color_size[color][]" /></td>
                                            <td data-title="XXS">
                                                <label><input type="hidden" name="mb_color_size[xxs][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label>
                                            </td>
                                            <td data-title="XS">
                                                <label><input type="hidden"  name="mb_color_size[xs][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label>
                                            </td>
                                            <td data-title="Small">
                                                <label><input type="hidden"  name="mb_color_size[small][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label>
                                            </td>
                                            <td data-title="Medium">
                                                <label><input type="hidden"  name="mb_color_size[medium][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label>
                                            </td>
                                            <td data-title="Large">
                                                <label><input type="hidden"  name="mb_color_size[large][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label>
                                            </td>
                                            <td data-title="Extra Large">
                                                <label><input type="hidden"  name="mb_color_size[extra_large][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label>
                                            </td>
                                            <td data-title="XXL">
                                                <label><input type="hidden"  name="mb_color_size[xxl][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label>
                                            </td>
                                            <td data-title="XXXL">
                                                <label><input type="hidden"  name="mb_color_size[xxxl][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label>
                                            </td>
                                            <td data-title="4XXL">
                                                <label><input type="hidden"  name="mb_color_size[four_xxl][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label>
                                            </td>
                                            <td data-title="One Size">
                                                <label><input type="hidden"  name="mb_color_size[one_size][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label>
                                            </td>
                                            {{-- <td><a href="javascript:void(0);" class="btn_delete" onclick="removeProductColorSize(this)"><i class="material-icons dp48">delete_outline</i><span>Delete</span></a></td> --}}
                                        </tr>
                                    </tbody>
                            ...
                            <div class="add_more_box" style="padding-top: 20px">
                                <a href="javascript:void(0);" class="add-more-block" onclick="addMbProductColorSize()"><i class="material-icons dp48">add</i> Add More</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col s12 m6 l6 input-field">
                                <div class="col 12">
                                    <label for="price_range" class="col-md-4 col-form-label text-md-right">Price Range <span class="text-danger">*</span></label>
                                </div>
                                <div class="col s12">
                                    <input id="price_range" type="text" class="form-control @error('price_range') is-invalid @enderror" name="price_range" value="{{ old('price_range') }}"  autocomplete="price_range" autofocus>
                                    <span  class="price_range_error text-danger error-rm"></span>
                                </div>
                            </div>
                            <div class="col s12 m6 l6 input-field">
                                <div class="col 12">
                                    <label for="lead_time" class="col-md-4 col-form-label text-md-right">Lead Time <span class="text-danger">*</span></label>
                                </div>
                                <div class="col s12">
                                    <input type="text" name="lead_time" id="lead_time" class="form-control negitive-or-text-not-allowed" placeholder="days" >
                                    <span class="lead_time_error text-danger error-rm"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row unit-block">
                    <div class="col s12 m6 l6 input-field">
                        <div class="col 12">
                            <label for="qty_unit" class="col-md-4 col-form-label text-md-right">Quantity Unit <span class="text-danger">*</span></label>
                        </div>
                        <div class="col s12">
                            ...
                            <span class="qty_unit_error text-danger error-rm"></span>
                        </div>
                    </div>
                    <div class="col s12 m6 l6 input-field">
                        <div class="s12">
