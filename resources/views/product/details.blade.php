...
@endif
<div class="row single-product-details-block-wrapper">
    <div class="col m4">
        <div class="product-images">
            <div class="card product-main-image">
                <div class="product-large-image-block">
                ...
                <div class="click-to-zoom">
                    <i class="material-icons dp48">zoom_in</i> Click on image to view large size.
                </div>
            </div>
            ...
            <div class="col m6">
                ...
                @else
                    <div class="single-product-price">
                        ...
                        <div class="single-product-price-value">
                            ...
                            @foreach (json_decode($product->attribute) as $k => $v)
                                ...
                                @endif
                            @endforeach
                            <a href="javascript:void(0);" class="show_attr_trigger show_more_price_options">Show more</a>
                    ...
                    <div class="single-product-moq">
                        MOQ: {{ $product->moq }} {{$product->product_unit}}
                    </div>

                    @if($product->customize == true)
                        <span class="badge badge pill blue accent-2 mr-2 ready-to-ship-label tooltipped" data-position="top" data-tooltip="Please click on request for modification to customize this product.">Can be Customizable</span>
                    @endif
                @endif
                ...
                <div class="single-product-review">
                    <div class="single-product-write-review">
                        <ul>
                            ...
                            <li><a class="waves-effect waves-light modal-trigger" href="#product-review-modal"><i class="material-icons dp48">edit</i> Write a review</a></li>
                            @elseif (!$productReviewExistsOrNot && !Auth::guard('web')->check())
                            <li><a class="waves-effect waves-light modal-trigger" href="#login-register-modal"><i class="material-icons dp48">edit</i> Write a review</a></li>
                            @else
                            @endif
            ...
            <div class="col m12">
                ...
                <div class="single-product-attributes">
                   ...
                   {{-- end non clothing type --}}
                    ...
                    @else
                    <a href="#login-register-modal" id="add_to_cart" data-id="{{$product->sku}}"class="btn waves-effect waves-light green addToCart modal-trigger" disabled="disabled">ADD TO CART</a>
                    @endif
                </div>
            </div>
        </div>
                    ...
                    <div class="product_short_details">
                        ...
                        <div class="product_price">
                            @if($item->full_stock == 1)
                                <span class="full-stock">Full Stock</span>
                            @else
                                @php
...
<div class="row single-product-store-information">
    <div class="col m12">
        <div class="card card-with-padding">
