        ...
        <table class="table table-striped shipping-charge-table" style="width: 100%;">
            ...
            <tbody>
                    <tr>
                        ...
                        <td><input type="number" name="shipping[unit_price][]" class="shipping-unit-price form-control" required /></td>
                        <td><input type="number" name="shipping[qty][]" class="shipping-qty form-control" required /></td>
                        <td><input type="number" name="shipping[total][]" class="shipping-total form-control" readonly required /></td>
                        <td>&nbsp;</td>
                    </tr>
            </tbody>
        </table>
