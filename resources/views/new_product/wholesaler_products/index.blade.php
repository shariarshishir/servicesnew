...
@section('content')
@include('new_product.wholesaler_products._add_product_modal')
@include('new_product.wholesaler_products._edit_product_modal')
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l9">
                                        ...
                                        <div class="product_design_wrapper profile_account_product">
                                            @if($view == 'grid')
                                                @include('new_product.wholesaler_products.products_list_grid_view')
                                            @else
                                                @include('new_product.wholesaler_products.products_list_list_view')
                                            @endif
                                        </div>
                                    </div>
...
@include('new_product.wholesaler_products._scripts')
