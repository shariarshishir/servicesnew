...
! function(e) {
    e.fn.imageUploader = function(t) {
        let n, i = {
                ...
                mimes: ["image/jpeg", "image/png", "image/gif", "image/svg+xml", "image/JPG", "image/JPEG", "image/PNG", "image/GIF", "image/SVG"],
                maxSize: void 0,
                maxFiles: void 0
            },
            a = this,
        ...
        let o = function() {
            ...
            l = function(t, i, o) {
                console.log(t.type);
                if(t.type == "application/vnd.ms-excel" || t.type == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
                {
                    var className = "uploaded-image xls_file";
                }
                else if(t.type == "application/pdf")
                {
                    var className = "uploaded-image pdf_file";
                }
                else if(t.type == "application/msword" || t.type == "application/vnd.openxmlformats-officedocument.wordprocessingml.document")
                {
                    var className = "uploaded-image doc_file";
                }
                else 
                {
                    var className = "uploaded-image normal_img_file";
                }
                let l = e("<div>", {
            ...
            u = function(t, n) {
                ...
                e(n).each(function(e, t) {
                    ...
                    var  myarray =['image/jpg', 'image/jpeg', 'image/JPG', 'image/JPEG', 'image/png', 'image/PNG', 'image/gif', 'image/GIF'];
                    if(jQuery.inArray(t.type, myarray) != -1)
                    {
                        s.items.add(t), i.append(l(URL.createObjectURL(t), s.items.length - 1), !1)
                    } 
                    else
                    {
                        s.items.add(t), i.append(l(t, s.items.length - 1), !1)
                    }                    
