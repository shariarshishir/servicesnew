                        ...
                        <div class="col m3 left-column">
                            <div class="module shop-categories-wrap">
                                ...
                                @foreach($categories as $category)
                                    <li  class="@php echo ($category['slug'] == $segment3)?' active':''; @endphp">
                                        <a href="{{route('readystock.categories.product',$category['slug'])}}">
                                            {{$category['name']}}
                                        ...
                                        <ul class="sub-level">
                                            @foreach($category['children'] as $childcategory)
                                                <li  class="@php echo ($childcategory['slug'] == $segment4)?' active':''; @endphp">
                                                    <a href="{{route('readystock.subcategories.product',['category'=>$category['slug'],'subcategory'=>$childcategory['slug']])}}">
                                                        {{ $childcategory['name'] }}
                                                    ...
                                                    <ul class="sub-level">
                                                        @foreach($childcategory['children'] as $childcategory2)
                                                            <li  class="@php echo ($childcategory2['slug'] == $segment5)?' active':''; @endphp">
                                                                <a href="{{route('readystock.sub.subcategories.product',['category'=>$category['slug'],'subcategory'=>$childcategory['slug'],'subsubcategory'=>$childcategory2['slug']])}}">{{ $childcategory2['name'] }}</a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                    @endif
                            ...
                            <form action="#" class="filter-search-form" method="get">
                                ...
                                <div class="module-rating-filter display-grid">
                                    ...
                                    @endif
                                <input type="hidden" name="filter_search_product_type" value="2">
