...
<div class="product_details_wrapper">
    <div class="single-product-details-block-wrapper">
        ...
        <div class="row">
            ...
            <div class="@php echo ($relatedProducts->isNotEmpty()) ? 'col m5':'col m9 product_preview_info_wrap' @endphp single-product-details-wrapper">
                            ...
                            <div class="single-product-price">
                                ...
                                <div class="single-product-price-value">
                                    ...
                                    @foreach (json_decode($product->attribute) as $k => $v)
                                        ...
                                        @endif
                                    @endforeach
                                    <a href="javascript:void(0);" class="show_attr_trigger show_more_price_options btn_green">Show more</a>
                        ...
                        <div class="single-product-review">
                            <div class="single-product-write-review">
                                <ul>
                                    ...
                                    <li><a class="btn_green waves-effect waves-light modal-trigger" href="#product-review-modal"><i class="material-icons dp48">edit</i> Write a review</a></li>
                                    @elseif (!$productReviewExistsOrNot && !Auth::guard('web')->check())
                                    <li><a class="btn_green waves-effect waves-light modal-trigger" href="#login-register-modal"><i class="material-icons dp48">edit</i> Write a review</a></li>
                                    @else
                                    @endif
                                ...
                                <div class="ready_stock_block_wrapper">
                                    <div class="row" style="margin-bottom: 0px;">
                                        <div class="col m12 ready_stock left-align">
                                            <span class="btn_green badge badge pill green accent-2 mr-2 ready-to-ship-label">Ready to Ship</span>
                                            @if($product->full_stock==1)
                                            <span class="badge badge pill blue accent-2 mr-2 ready-to-ship-label">Full Stock</span>
                                            @endif
                                        </div>
