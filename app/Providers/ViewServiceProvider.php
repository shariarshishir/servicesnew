...
class ViewServiceProvider extends ServiceProvider
{
    ...
    {
        //product tags
        view()->composer(['new_business_profile.manufacturer_products.index','business_profile.show','business_profile._edit_modal_data','wholesaler_profile.products.index','product.details','product.manufactrue_product_details','rfq.create','rfq._create_rfq_form_modal','rfq._edit_rfq_modal'], function($view){
