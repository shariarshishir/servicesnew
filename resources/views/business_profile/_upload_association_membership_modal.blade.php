            ...
            <div class="row">
                <div class="form-group  association-membership-details-block">
                    ...
                    <div class="association-membership-details-block">
                        ...
                        <a href="javascript:void(0);" class="btn waves-effect waves-light green add-more-block btn_green" onclick="addAssociationMembershipDetails()"><i class="material-icons dp48">add</i> Add More</a>
                    </div>
                </div>
            </div>
