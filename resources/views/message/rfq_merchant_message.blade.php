@extends('layout.app')
@section('page_title')
    {{ 'Merchant Bay | RFQ Merchant Message' }}
@endsection
...
@section('contents')
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 ic-r4q-title">
                    <h2 style="margin-bottom:20px;">Messege center</h2>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-10">
                    ...
                    <a href="{{ action('MessageController@rfq_merchant_message') }}" class="btn btn-default" style="background-color:#55A860; padding: 14px 40px; border-radius: 10px; font-size:16px;"><i class="glyphicon glyphicon-envelope"></i><br/>RFQ Merchant </a> &nbsp; &nbsp;
    ...
    <section class="ic-messanger-wrapper">
        <rfq-merchant-message></rfq-merchant-message>
    </section>
@endsection
