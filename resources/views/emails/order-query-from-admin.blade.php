    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td style="padding: 30px;">
                <p style="font-family:verdana;font-size:13px;margin:0px;line-height:normal;">Dear {{ $query->orderModificationRequest->user->name}},</p>
                ...
                <p style="font-family:verdana;font-size:12px;margin:0px;color:#000;line-height:normal;">Product name: {{ $query->name }}</p>
                <p style="font-family:verdana;font-size:12px;color:#000;margin:0px;padding-bottom:15px;line-height:normal;"><a href="{{ route('user.order.query.index') }}">To see the details please click here.</a></p>
