    ...
    <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <label for="productCategory">productCategory Name :</label>
                    <input type="text" name="name" class="form-control col-sm-4" id="productCategory" value="{{old('name', $productCategory->name)}}" placeholder="Enter productCategory">
                        @if($errors->has('name'))
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="form-group">
                ...
                <input id="image" type="file" name="image" class="form-control col-sm-4" value="{{old('image', $productCategory->image)}}" placeholder="Enter productCategory">
                @if($errors->has('image'))
