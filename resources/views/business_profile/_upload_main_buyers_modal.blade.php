            ...
            <div class="row">
                <div class="form-group  main-buyers-details-block">
                    ...
                    <div class="main-buyers-details-block">
                        ...
                        <a href="javascript:void(0);" class="btn_green btn waves-effect waves-light green add-more-block" onclick="addMainBuyersDetails()"><i class="material-icons dp48">add</i> Add More</a>
                    </div>
                </div>
            </div>
