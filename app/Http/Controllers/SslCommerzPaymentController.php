...
class SslCommerzPaymentController extends Controller
{
    ...
    public function exampleEasyCheckout($order_no)
    {
        $orderList=VendorOrder::where('order_number',$order_no)->with('orderItems')->first();
        return view('sslcommerce.exampleEasycheckout', compact('orderList'));
    }
    ...
    public function payViaAjax(Request $request)
    {
        ...
        # OPTIONAL PARAMETERS
        $post_data['value_a'] =  $requestData['order_no'];
        ...
        $update_product = DB::table('vendor_orders')
            ->where('order_number', $requestData['order_no'])
            ->update([
                'pay_amount' => $post_data['total_amount'],
    ...
    public function success(Request $request)
    {
        ...
        $order_detials = DB::table('vendor_orders')
            ->where('transaction_id', $tran_id)
            ->select('transaction_id', 'payment_status', 'currency', 'pay_amount')->first();
