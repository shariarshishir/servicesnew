                            ...
                            <div class="imgBox" >
                                ...
                                @else
                                    @if($list->overlay_image)
                                        <img src="{{Storage::disk('s3')->url('public/'.$list->overlay_image)}}" class="single-product-overlay-img" alt="" style="display: none;" >
                                    @endif
                                @endif
                            </div>
...
@if($user)
    ...
    @endif
@else
    <div class="explore_more_product">(To explore more <a href="{{env('SSO_REGISTRATION_URL')}}">Click here</a> to become a verified user)</div>
@endif
