            ...
            <table style="background: #fff; max-width:670px; margin:0 auto; padding: 20px; text-align: left;" width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="padding: 50px 0 0; margin: 0;">
                        <h1 style="font-family: 'Poppins', sans-serif; font-weight: 600; padding: 0px 0px 30px 0px; margin: 0px; font-size:36px; line-height: 50px; color: #0A0A0A;">New Quotation have been posted on your RFQ.</h1>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: left; padding: 0 0 50px; margin: 0;" >
                        <p style="margin: 0; padding: 2px 0px; font-family: 'Poppins', sans-serif; font-size: 15px; line-height: 24px; color: #0A0A0A;">Please <a href="https://www.merchantbay.com/" target="_blank">login</a> to Merchant Bay. To see view details.</p>
                    </td>
                </tr>
            </table>
