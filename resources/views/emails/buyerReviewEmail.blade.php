    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td style="padding: 30px;">
                <p style="font-family:verdana;font-size:13px;margin:0px;line-height:normal;">Dear {{ $vendorOrder->vendor->user->name }},</p>
                <p style="font-family:verdana;font-size:12px;color:#000;margin:0px;padding-bottom:15px;line-height:normal;">Seems like you have completed a successful trade with {{ $vendorOrder->user->name }}. Please review the experience.</p>
                <p style="display:block;text-align:center;margin:0px;padding-bottom:25px;line-height:normal;"><a href="{{route('vendor.review_form',[$vendorOrder['order_number'],$vendorOrder->user->vendor['vendor_uid']])}}">Click here </a></p>
