...
<script>
   ...
   //edit non clothing attr counting
    ...
    $('#seller_product_form').on('submit',function(e){
            ...
            // this_master.find('.mb-color-size-table-block input[type="checkbox"]').each( function () {
            ...
            var url = '{{ route("new.store.product") }}';
...
//add more video
    ...
    // });
    function addMbProductColorSize()
    {
        let totalChild = $('.mb-color-size-table-block tbody').children().length;
        var html = '<tr>';
        html += '<td data-title="Color"><input type="text"  class="form-control" name="mb_color_size[color][]" /></td>';
        html += '<td data-title="XXS"><label><input type="hidden" name="mb_color_size[xxs][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label></td>';
        html += '<td data-title="XS"><label><input type="hidden"  name="mb_color_size[xs][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label></td>';
        html += '<td data-title="Small"><label><input type="hidden"  name="mb_color_size[small][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label></td>';
        html += '<td data-title="Medium"><label><input type="hidden"  name="mb_color_size[medium][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label></td>';
        html += '<td data-title="Large"><label><input type="hidden"  name="mb_color_size[large][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label></td>';
        html += '<td data-title="Extra Large"><label><input type="hidden"  name="mb_color_size[extra_large][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label></td>';
        html += '<td data-title="XXL"><label><input type="hidden"  name="mb_color_size[xxl][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label></td>';
        html += '<td data-title="XXXL"><label><input type="hidden"  name="mb_color_size[xxxl][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label></td>';
        html += '<td data-title="4XXL"><label><input type="hidden"  name="mb_color_size[four_xxl][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label></td>';
        html += '<td data-title="One Size"><label><input type="hidden"  name="mb_color_size[one_size][]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value"/><span></span></label></td>';
        html += '<td><a href="javascript:void(0);" class="btn_delete" onclick="removeMbProductColorSize(this)"><i class="material-icons dp48">delete_outline</i> <span>Delete</span></a></td>';
        html += '</tr>';
        $('.mb-color-size-table-block tbody').append(html);
    }
    function removeMbProductColorSize(el)
    {
