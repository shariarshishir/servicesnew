                        ...
                        <table style="max-width:670px; margin:0 auto; padding: 20px; text-align: left;" width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="text-align: left; padding: 5px; margin: 0px; width: 50%;">
                                    <a target="_blank" href="{{route('new.profile.index',$business_profile->alias)}}" style="background: #54A958; font-family: 'Poppins', sans-serif; font-size: 16px; line-height: 24px; border-radius: 8px; padding: 10px 20px; margin: 0; color: #fff; text-decoration: none;">Edit profile</a>
                                </td>
                            </tr>
                        </table>
                    </td>
