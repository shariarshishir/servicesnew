            ...
            <div class="row">
                <div class="form-group  press-highlight-details-block">
                    ...
                    <div class="press-highlight-details-block">
                        ...
                        <a href="javascript:void(0);" class="btn waves-effect waves-light green add-more-block btn_green" onclick="addPressHighlightDetails()"><i class="material-icons dp48">add</i> Add More</a>
                    </div>
                </div>
            </div>
