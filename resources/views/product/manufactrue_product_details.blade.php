...
@include('sweet::alert')
    ...
    <section class="">
        <div class="container">
            ...
            <h3 class="category_name"><a href="#">{{ $product->category['name'] }}</a></h3>
        </div>
    </section>
            ...
            <div class="row ic-pg-container">
                ...
                <div class="col s12 m9 l9 product_preview_info_wrap">
                    <div class="row">
                        ...
                        <div class="col s12 m4 l4 product_preview_right center-align">
                            <div id="place_order_buttons" class="ic-place-order right-align">
                                ...
                                @if(Auth::guard('web')->check())
                                    <button type="button" class="ic-btn btn_green" >Contact supplier</button>
                                @else
