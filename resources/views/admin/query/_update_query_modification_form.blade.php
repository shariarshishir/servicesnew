            ...
            <table class="color-size-table-block ord-mod-color-sizes">
                ...
                <tbody class="ord-mod-color-tbody">
                    ...
                    @foreach (json_decode($collection->orderModification->colors_sizes) as $detail)
                        ...
                        <tr>
                            <td><input type="text" value="{{ $detail->color }}" class="form-control" name="color_size[color][]" @if($collection->type == 1) readonly @endif/></td>
                            <td><input type="text" value="{{ $detail->xxs }}" class="form-control count-color-size" name="color_size[xxs][]" @if($collection->type == 1) readonly @endif/></td>
                            <td><input type="text" value="{{ $detail->xs }}" class="form-control count-color-size" name="color_size[xs][]" @if($collection->type == 1) readonly @endif/></td>
                            <td><input type="text" value="{{ $detail->small }}" class="form-control count-color-size" name="color_size[small][]" @if($collection->type == 1) readonly @endif/></td>
                            <td><input type="text" value="{{ $detail->medium }}" class="form-control count-color-size" name="color_size[medium][]" @if($collection->type == 1) readonly @endif/></td>
                            <td><input type="text" value="{{ $detail->large }}" class="form-control count-color-size" name="color_size[large][]" @if($collection->type == 1) readonly @endif/></td>
                            <td><input type="text" value="{{ $detail->extra_large }}" class="form-control count-color-size" name="color_size[extra_large][]" @if($collection->type == 1) readonly @endif/></td>
                            <td><input type="text" value="{{ $detail->xxl }}" class="form-control count-color-size" name="color_size[xxl][]" @if($collection->type == 1) readonly @endif/></td>
                            <td><input type="text" value="{{ $detail->xxxl }}" class="form-control count-color-size" name="color_size[xxxl][]" @if($collection->type == 1) readonly @endif/></td>
                            <td><input type="text" value="{{ $detail->four_xxl }}" class="form-control count-color-size" name="color_size[four_xxl][]" @if($collection->type == 1) readonly @endif/></td>
                            <td><input type="text" value="{{ $detail->one_size }}" class="form-control count-color-size" name="color_size[one_size][]" @if($collection->type == 1) readonly @endif/></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
