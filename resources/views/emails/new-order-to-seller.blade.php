    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td style="padding: 30px;">
                ...
                <p style="font-family:verdana;font-size:12px;color:#000;margin:0px;padding-bottom:15px;line-height:normal;"><a href="{{ route('wholesaler.order.index',[ 'business_profile_id'=> $order->businessProfile->id ]) }}">Click here to see the order details</a></p>
