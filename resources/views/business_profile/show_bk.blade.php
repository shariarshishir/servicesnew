                ...
                <div id="profile" class="tabcontent">
                  <div class="overview_table_wrap">
                    <div class="row top_titleWrap">
                      ...
                      <div class="col s6 m6 right-align editBox">
                        <button data-target="modal1" type="button" class="btn_edit btn_green_White modal-trigger" >
                  ...
                  <div class="overview_table_wrap capacity_machineries">
                    <div class="row top_titleWrap">
                      ...
                      <div class="col s6 m6 right-align editBox">
                        <button type="button" class="btn_edit btn_green_White" >
                          <span class="btn_icon"><i class="material-icons">border_color</i></span>
                          <span class="btn_edit_white"> Edit</span>
                        </button>
                      </div>
                  ...
                  <div class="overview_table_wrap machinery_table">
                      ...
                      <div class="overview_table box_shadow">
                        <table>
                          ...
                          <tbody>
                            <tr>
                              <td>SHIMA SEIKI Double System 5GG & 7GG</td>
                              <td>12 sets</td>
                              <td>
                                <div class="verified_img">
                                  <img class="right-align" src="./images/verified.png" />
                            ...
                            <tr>
                              <td>SHIMA SEIKI Double System 12GG & 14GG</td>
                              <td>44 sets</td>
                              <td>
                                <div class="verified_img">
                                  <img class="right-align" src="./images/verified.png" />
                            ...
                            <tr>
                              <td>Jaquard Double System 5GG & 7GG</td>
                              <td>65 sets</td>
                                <td>
                                  <div class="verified_img">
                                    <img class="right-align" src="./images/verified.png" />
                  ...
                  <div class="certifications">
                    <div class="row top_titleWrap upload_delete_wrap">
                      ...
                      <div class="col s6 m6 right-align editBox">
                        <button type="button" class="btn_upload btn_green_White" >
                          <span class="btn_icon"><i class="material-icons">file_upload</i></span>
                          <span class="btn_edit_white"> Upload</span>
                        </button>
                        <button type="button" class="btn_delete btn_green_White" >
...
<div class="row">
    <div class="row">
        ...
        <div id="test2" class="col s12">
           ...
           <h3>Capacity and machinaries</h3>
            <a class="waves-effect waves-light btn modal-trigger" href="#capacity_and_machinaries_modal">edit</a>
            <h4>Production (Capacity Annual)</h4>
            <table>
                <thead>
                  <tr>
            ...
            {{-- company overview edit modal --}}
            <div id="capacity_and_machinaries_modal" class="modal">
                <div class="modal-content">
                                    ...
                                    <table class="production-capacity-table-block">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input name="annual_capacity[]" id="annual_capacity" type="text" class="form-control "  value="" ></td>
                                    ...
                                    <table class="categories-produced-table-block">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input name="percentage[]" id="percentage" type="text" class="form-control "  value="" ></td>
                                ...
                                <table class="machinaries-details-table-block">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input name="quantity[]" id="quantity" type="text" class="form-control "  value="" ></td>
